 ...
 * 
 */
@WebServiceClient(name = "MyWebServiceImplService", targetNamespace = "http://service.demo.example.com", wsdlLocation = "http://127.0.0.1:9090/user?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYWEBSERVICEIMPLSERVICE_QNAME = new QName("http://service.demo.example.com", "MyWebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:9090/user?wsdl");
     ...
     * 
     * @return
     *     returns MyWebServiceTest
     */
    @WebEndpoint(name = "MyWebServiceTestPort")
    public MyWebServiceTest getMyWebServiceTestPort() {
        return super.getPort(new QName("http://service.demo.example.com", "MyWebServiceTestPort"), MyWebServiceTest.class);
    }
     ...
     */
    @WebEndpoint(name = "MyWebServiceTestPort")
    public MyWebServiceTest getMyWebServiceTestPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.demo.example.com", "MyWebServiceTestPort"), MyWebServiceTest.class, features);
    }
